...
echo or AI_실행_딸깍.bat and you just want to watch the stream.
echo ========================================================
...
echo.
ssh -N -L 8888:127.0.0.1:8888 -L 8889:127.0.0.1:8889 -L 8189:127.0.0.1:8189 -L 8010:127.0.0.1:8010 -L 8011:127.0.0.1:8011 -L 8012:127.0.0.1:8012 -L 8013:127.0.0.1:8013 welabs@58.127.241.84
